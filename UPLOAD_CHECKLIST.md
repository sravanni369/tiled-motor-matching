...
Suggested new repository: `tiled-motor-matching`.

Upload the contents of this folder, retaining filenames: main.py, validate.py, requirements.txt, README.md, results.json, PROJECT_PROMPT.md, CLAUDE_REVIEW_PROMPT.md, .gitignore, this checklist, and any final infographic/caption supplied with the package. Review with Claude first. GitHub's web upload can omit hidden .gitignore; create that file manually if necessary.
